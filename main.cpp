...
int main()
{
    ...
    std::function<std::unique_ptr<continuation<void, std::string, int>>(std::string, int)> cr = [](std::string q, int x) { return std::unique_ptr<continuation<void, std::string, int>>(new creturn<void, std::string, int>("s"+q, 3));};
